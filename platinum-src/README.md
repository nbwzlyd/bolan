# Android DLNA - Platinum UPnP SDK
...
基于 [Platinum UPnP SDK](https://github.com/plutinosoft/Platinum) 的 Android DLNA 投屏方案，支持 MediaRenderer（媒体渲染器）功能，可实现手机/电脑投屏到 Android 设备。

## 项目简介

本仓库为 Android DLNA 投屏的核心 C++ 源码，基于 Platinum UPnP SDK 1.3.0 版本，已针对 Android 平台进行优化：

- ✅ 支持 Android 平台 CMake 编译
- ✅ 支持 16KB 页面对齐（Android 15+ 兼容）
- ✅ 支持 arm64-v8a / armeabi-v7a 双架构
- ✅ 内置 MediaRenderer（DMR）媒体渲染器
...
使用 CMake + NDK 编译，支持 Android Studio 集成。详细请参考 [ANDROID_BUILD.md](ANDROID_BUILD.md)。
...
add_library(platinum SHARED
    your-jni-code.cpp
    # ... 源文件
)

target_link_options(platinum PRIVATE 
