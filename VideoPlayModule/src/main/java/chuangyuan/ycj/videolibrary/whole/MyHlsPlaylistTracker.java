 ...
 */
public final class MyHlsPlaylistTracker
    ...
    /**
     * Factory for {@link MyHlsPlaylistTracker} instances.
     */
    ...
    public void start(
        ...
        initialPlaylistLoader = new Loader("MyHlsPlaylistTracker:MasterPlaylist");
    ...
    private final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public MediaPlaylistBundle(Uri playlistUrl) {
            ...
            mediaPlaylistLoader = new Loader("MyHlsPlaylistTracker:MediaPlaylist");
